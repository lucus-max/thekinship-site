...
const projects = [
  ...
  {
    slug: 'nike-nothing-beats-a-londoner',
    title: 'NIKE - NOTHING BEATS A LONDONER',
    subtitle: 'Lead Comp',
    description: 'Time Based Arts',
    category: 'Brand Work',
    image: '/media/nike-nothing-beats-a-londoner.jpg',
    video: 'https://pub-5b43fd3787f84e3da4a241819cb889ab.r2.dev/nike-nothing-beats-a-londoner.mp4',
  },
  {
    slug: 'playstation-play-has-no-limits',
    title: 'PLAYSTATION - PLAY HAS NO LIMITS',
    subtitle: 'Lead Comp',
    description: 'Time Based Arts',
    category: 'Brand Work',
    image: '/media/playstation-play-has-no-limits.jpg',
    video: 'https://pub-5b43fd3787f84e3da4a241819cb889ab.r2.dev/playstation-play-has-no-limits.mp4',
  },
  {
    slug: 'ee-gamer',
    title: 'EE GAMER',
